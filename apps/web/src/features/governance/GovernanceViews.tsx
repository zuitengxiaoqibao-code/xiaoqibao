...
type Props = { view: "xingbu" | "libu" | "dongchang"; loadRisk?: () => Promise<RiskStatus>; loadCompliance?: () => Promise<ComplianceStatus>; loadAudit?: () => Promise<AuditStatus>; complianceAction?: (source: string, action: "authorize" | "revoke" | "acknowledge", permissionReference?: string) => Promise<unknown> };
export function GovernanceView(props: Props) {
  ...
  async function runComplianceAction(source: string, action: "authorize" | "revoke" | "acknowledge") {
    ...
    try { await props.complianceAction(source, action, references[source]); setData(await props.loadCompliance()); }
